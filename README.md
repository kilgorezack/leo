# Northline — landing site

A fast, static, dependency-free marketing site for **Northline Communications**.
...
`https://northline.vercel.app`. Replace that with your real domain in:
